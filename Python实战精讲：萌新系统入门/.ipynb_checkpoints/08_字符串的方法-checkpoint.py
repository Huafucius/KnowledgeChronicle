...
# find
print("="*10,"find","="*10) #这画了一个分割线，方便观看输出结果，下同
...
# count 返回找到的元素的个数
print("="*10,"count","="*10)
print(info.count('and')) # 两个and返回2
print(info.count('and',15,30)) # 区间内一个and返回1
print(info.count('apple')) # 没有apple返回0
...
print("666".join(temp)) # 选择使用"666"拼接
